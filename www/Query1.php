...
<!-- Page Wrapper -->
    ...
    try {
        ...
        //查詢該科系學生的資料
        //SELECT * FROM STUDENT WHERE `SDepartment` = "Arts"
        // 檢查是否有使用者輸入的關鍵字
        if (isset($_POST['keyword'])) {
            ...
            if ($stmt->execute()) {
                ...
                if ($total_records > 0) {
                    ...
                    echo "<br/>";
                    echo "<br/>";
                    echo "<tr><th>Name</th><th>SID</th><th>Gender</th><th>Grade</th><th>科系</th><th>Phon_Number</th><th>Email</th></tr>";
    ...
    <form method="post" action="">
        <br/>輸入學生的科系: <input type="text" name="keyword"  />
        <br/>
